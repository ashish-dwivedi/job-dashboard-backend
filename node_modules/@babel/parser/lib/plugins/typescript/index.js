  ...
  class extends superClass {
    ...
    tsNextTokenCanFollowModifier() {
      ...
      return (
        ...
        !this.match(_types.types.parenR) &&
        !this.match(_types.types.colon) &&
        !this.match(_types.types.eq) &&
        !this.match(_types.types.question) &&
        !this.match(_types.types.bang)
      );
    }
    ...
    tsParseNonArrayType() {
      switch (this.state.type) {
        ...
        case _types.types._null: {
          const type = this.match(_types.types._void)
            ? 'TSVoidKeyword'
            : this.match(_types.types._null)
            ? 'TSNullKeyword'
    ...
    tsParseEnumDeclaration(node, isConst) {
      ...
      this.checkLVal(
        node.id,
        isConst ? _scopeflags.BIND_TS_CONST_ENUM : _scopeflags.BIND_TS_ENUM,
        undefined,
