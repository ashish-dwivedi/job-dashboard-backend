  ...
  class extends superClass {
    ...
    flowParseDeclareExportDeclaration(node, insideModule) {
      ...
      if (this.eat(_types.types._default)) {
        ...
        if (
          this.match(_types.types._const) ||
          this.isLet() ||
        ...
        if (
          this.match(_types.types._var) ||
          this.match(_types.types._function) ||
          this.match(_types.types._class) ||
          ...
          this.match(_types.types.braceL) ||
    ...
    flowParseObjectTypeProperty(node, isStatic, protoStart, variance, kind, allowSpread, allowInexact) {
      if (this.eat(_types.types.ellipsis)) {
        const isInexactToken =
          this.match(_types.types.comma) ||
          this.match(_types.types.semi) ||
          this.match(_types.types.braceR) ||
          this.match(_types.types.braceBarR);
        ...
        case _types.types.parenL:
          ...
          if (isGroupedType) {
            ...
            if (
              ...
              !(this.match(_types.types.comma) || (this.match(_types.types.parenR) && this.lookahead().type === _types.types.arrow))
            ) {
              this.expect(_types.types.parenR);
              return type;
            } else {
      ...
      if (expr.type === 'Identifier') {
        if (expr.name === 'declare') {
          if (
            ...
            this.match(_types.types._function) ||
            this.match(_types.types._var) ||
            this.match(_types.types._export)
          ) {
    ...
    flowEnumMemberRaw() {
      ...
      const init = this.eat(_types.types.eq)
