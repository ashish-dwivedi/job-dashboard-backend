...
class StatementParser extends _expression.default {
  ...
  parseVarId(decl, kind) {
    ...
    this.checkLVal(
      decl.id,
      kind === 'var' ? _scopeflags.BIND_VAR : _scopeflags.BIND_LEXICAL,
      undefined,
    ...
    this.scope.declareName(
      ...
      this.state.strict || node.generator || node.async
        ? this.scope.treatFunctionsAsVar
          ...
          : _scopeflags.BIND_LEXICAL
        : _scopeflags.BIND_FUNCTION,
      node.id.start
    );
  }
  ...
  parseClassMemberWithIsStatic(classBody, member, state, isStatic, constructorAllowsSuper) {
    ...
    if (this.isClassMethod()) {
      ...
      !containsEsc &&
      !(this.match(_types2.types.star) && this.isLineTerminator())
    ) {
  ...
  pushClassPrivateMethod(classBody, method, isGenerator, isAsync) {
    ...
    const kind =
      node.kind === 'get'
        ? node.static
          ? _scopeflags.CLASS_ELEMENT_STATIC_GETTER
          : _scopeflags.CLASS_ELEMENT_INSTANCE_GETTER
        : node.kind === 'set'
        ? node.static
          ? _scopeflags.CLASS_ELEMENT_STATIC_SETTER
          : _scopeflags.CLASS_ELEMENT_INSTANCE_SETTER
        : _scopeflags.CLASS_ELEMENT_OTHER;
