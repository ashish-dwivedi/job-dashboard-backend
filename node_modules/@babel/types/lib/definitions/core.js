  ...
  fields: {
    ...
    left: {
      validate: !process.env.BABEL_TYPES_8_BREAKING
        ...
        : (0, _utils.assertNodeType)('Identifier', 'MemberExpression', 'ArrayPattern', 'ObjectPattern'),
    },
    right: {
  ...
  fields: Object.assign(
    {
      ...
      arguments: {
        validate: (0, _utils.chain)(
          (0, _utils.assertValueType)('array'),
          (0, _utils.assertEach)((0, _utils.assertNodeType)('Expression', 'SpreadElement', 'JSXNamespacedName', 'ArgumentPlaceholder'))
        ),
      },
    },
  ...
  fields: {
    left: {
      validate: !process.env.BABEL_TYPES_8_BREAKING
        ...
        : (0, _utils.assertNodeType)('VariableDeclaration', 'Identifier', 'MemberExpression', 'ArrayPattern', 'ObjectPattern'),
    },
    right: {
      validate: (0, _utils.assertNodeType)('Expression'),
    },
...
const functionCommon = {
  params: {
    validate: (0, _utils.chain)(
      (0, _utils.assertValueType)('array'),
      (0, _utils.assertEach)((0, _utils.assertNodeType)('Identifier', 'Pattern', 'RestElement', 'TSParameterProperty'))
    ),
  },
  generator: {
    default: false,
...
(0, _utils.default)('RestElement', {
  ...
  fields: Object.assign({}, patternLikeCommon, {
    argument: {
      validate: !process.env.BABEL_TYPES_8_BREAKING
        ? (0, _utils.assertNodeType)('LVal')
        : (0, _utils.assertNodeType)('Identifier', 'Pattern', 'MemberExpression'),
    },
  }),
