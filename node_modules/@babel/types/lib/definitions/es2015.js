  ...
  fields: Object.assign({}, _core.patternLikeCommon, {
    elements: {
      validate: (0, _utils.chain)(
        ...
        (0, _utils.assertEach)((0, _utils.assertNodeOrValueType)('null', 'PatternLike'))
      ),
    },
    decorators: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)('array'), (0, _utils.assertEach)((0, _utils.assertNodeType)('Decorator'))),
...
(0, _utils.default)('ImportDeclaration', {
  ...
  fields: {
    specifiers: {
      validate: (0, _utils.chain)(
        (0, _utils.assertValueType)('array'),
        (0, _utils.assertEach)((0, _utils.assertNodeType)('ImportSpecifier', 'ImportDefaultSpecifier', 'ImportNamespaceSpecifier'))
      ),
    },
    source: {
      validate: (0, _utils.assertNodeType)('StringLiteral'),
