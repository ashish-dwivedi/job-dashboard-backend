...
function isExpression(node, opts) {
  ...
  if (
    ...
    (nodeType === 'Placeholder' &&
      ('Expression' === node.expectedNode || 'Identifier' === node.expectedNode || 'StringLiteral' === node.expectedNode))
  ) {
    if (typeof opts === 'undefined') {
      return true;
    } else {
...
function isStatement(node, opts) {
  ...
  if (
    ...
    (nodeType === 'Placeholder' &&
      ('Statement' === node.expectedNode || 'Declaration' === node.expectedNode || 'BlockStatement' === node.expectedNode))
  ) {
    if (typeof opts === 'undefined') {
      return true;
    } else {
