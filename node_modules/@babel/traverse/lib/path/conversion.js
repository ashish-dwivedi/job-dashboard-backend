...
function arrowFunctionToExpression({ allowInsertArrow = true, specCompliant = false } = {}) {
  ...
  if (specCompliant) {
    ...
    this.replaceWith(
      t.callExpression(t.memberExpression((0, _helperFunctionName.default)(this, true) || this.node, t.identifier('bind')), [
...
function standardizeSuperProperty(superProp) {
  if (superProp.parentPath.isAssignmentExpression() && superProp.parentPath.node.operator !== '=') {
    ...
    if (superProp.node.computed) {
      ...
      assignmentPath
        .get('left')
        .replaceWith(t.memberExpression(superProp.node.object, t.assignmentExpression('=', tmp, superProp.node.property), true));
      assignmentPath
        .get('right')
        .replaceWith(t.binaryExpression(op, t.memberExpression(superProp.node.object, t.identifier(tmp.name), true), value));
    } else {
      assignmentPath.get('left').replaceWith(t.memberExpression(superProp.node.object, superProp.node.property));
      assignmentPath
        .get('right')
        .replaceWith(t.binaryExpression(op, t.memberExpression(superProp.node.object, t.identifier(superProp.node.property.name)), value));
    }
