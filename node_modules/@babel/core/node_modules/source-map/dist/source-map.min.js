      ...
      (t.prototype._version = 3),
        ...
        (t.prototype.setSourceContent = function(e, n) {
          ...
          null != this._sourceRoot && (r = i.relative(this._sourceRoot, r)),
            null != n
              ? (this._sourcesContents || (this._sourcesContents = Object.create(null)), (this._sourcesContents[i.toSetString(r)] = n))
        ...
        (t.prototype._validateMapping = function(e, n, r, t) {
          ...
          if (
            ...
            throw new Error('Invalid mapping: ' + JSON.stringify({ generated: e, source: r, original: n, name: t }));
        }),
        (t.prototype._serializeMappings = function() {
          for (
            var e, n, r, t, s = 0, a = 1, u = 0, l = 0, c = 0, g = 0, p = '', h = this._mappings.toArray(), f = 0, d = h.length;
            f < d;
            f++
          ) {
            if (((n = h[f]), (e = ''), n.generatedLine !== a)) for (s = 0; n.generatedLine !== a; ) (e += ';'), a++;
            else if (f > 0) {
            ...
            (e += o.encode(n.generatedColumn - s)),
              ...
              null != n.source &&
                ...
                (u = n.originalColumn),
                null != n.name && ((r = this._names.indexOf(n.name)), (e += o.encode(r - c)), (c = r))),
              (p += e);
          }
          return p;
        }),
    ...
    function(e, n) {
      ...
      function i(e) {
        ...
        for (var s, a = n.isAbsolute(r), u = r.split(/\/+/), l = 0, c = u.length - 1; c >= 0; c--)
          (s = u[c]),
            '.' === s ? u.splice(c, 1) : '..' === s ? l++ : l > 0 && ('' === s ? (u.splice(c + 1, l), (l = 0)) : (u.splice(c, 2), l--));
              ...
              : ((t = e.originalColumn - n.originalColumn),
                0 !== t || r
                  ...
                  : ((t = e.generatedColumn - n.generatedColumn),
                    0 !== t ? t : ((t = e.generatedLine - n.generatedLine), 0 !== t ? t : e.name - n.name))));
      }
      function h(e, n, r) {
            ...
            0 !== t || r
              ...
              : ((t = e.source - n.source),
                0 !== t
                  ? t
                  : ((t = e.originalLine - n.originalLine),
                    0 !== t ? t : ((t = e.originalColumn - n.originalColumn), 0 !== t ? t : e.name - n.name))));
      }
      function f(e, n) {
              ...
              : ((r = f(e.source, n.source)),
                0 !== r
                  ...
                  : ((r = e.originalLine - n.originalLine),
                    0 !== r ? r : ((r = e.originalColumn - n.originalColumn), 0 !== r ? r : f(e.name, n.name)))));
      }
      n.getArg = r;
      var m = /^(?:([\w+\-.]+):)?\/\/(?:(\w+:\w+)@)?([\w.]*)(?::(\d+))?(\S*)$/,
        _ = /^data:.+\,.+$/;
      ...
      (t.fromSourceMap = function(e) {
        ...
        (o.fromSourceMap = function(e) {
          ...
          (n.sourceRoot = e._sourceRoot),
            ...
            (n.file = e._file);
          for (
            var s = e._mappings.toArray().slice(), u = (n.__generatedMappings = []), c = (n.__originalMappings = []), p = 0, h = s.length;
            p < h;
            p++
          ) {
            var f = s[p],
          ...
          if (r >= 0) {
            ...
            if (o.generatedLine === n.generatedLine) {
              ...
              return (
                ...
                { source: i, line: a.getArg(o, 'originalLine', null), column: a.getArg(o, 'originalColumn', null), name: s }
              );
            }
          }
        ...
        (o.prototype.generatedPositionFor = function(e) {
          ...
          if ((null != this.sourceRoot && (n = a.relative(this.sourceRoot, n)), !this._sources.has(n)))
            return { line: null, column: null, lastColumn: null };
          n = this._sources.indexOf(n);
          var r = { source: n, originalLine: a.getArg(e, 'line'), originalColumn: a.getArg(e, 'column') },
            o = this._findMapping(
              r,
              this._originalMappings,
              'originalLine',
        ...
        (s.prototype.originalPositionFor = function(e) {
          ...
          return t
            ? t.consumer.originalPositionFor({
                ...
                column:
                  n.generatedColumn - (t.generatedOffset.generatedLine === n.generatedLine ? t.generatedOffset.generatedColumn - 1 : 0),
                bias: e.bias,
              })
          ...
          for (var r = 0; r < this._sections.length; r++)
            for (var t = this._sections[r], o = t.consumer._generatedMappings, i = 0; i < o.length; i++) {
              ...
              var c = {
                ...
                generatedColumn:
                  s.generatedColumn + (t.generatedOffset.generatedLine === s.generatedLine ? t.generatedOffset.generatedColumn - 1 : 0),
      ...
      (t.fromStringWithSourceMap = function(e, n, r) {
        ...
        (t.prototype.walk = function(e) {
          for (var n, r = 0, t = this.children.length; r < t; r++)
            (n = this.children[r]),
              n[u] ? n.walk(e) : '' !== n && e(n, { source: this.source, line: this.line, column: this.column, name: this.name });
        }),
              ...
              (n.code += e),
                null !== o.source && null !== o.line && null !== o.column
                  ? ((i === o.source && s === o.line && u === o.column && l === o.name) ||
                    ...
                    (l = o.name),
                    (t = !0))
                  : t && (r.addMapping({ generated: { line: n.line, column: n.column } }), (i = null), (t = !1));
