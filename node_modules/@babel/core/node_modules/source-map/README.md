...
function compile(ast) {
  switch (ast.type) {
    case 'BinaryExpression':
      return new SourceNode(ast.location.line, ast.location.column, ast.location.source, [compile(ast.left), ' + ', compile(ast.right)]);
    case 'Literal':
...
```js
var node = new SourceNode(1, 2, 'a.js', [new SourceNode(3, 4, 'b.js', 'uno'), 'dos', ['tres', new SourceNode(5, 6, 'c.js', 'quatro')]]);
